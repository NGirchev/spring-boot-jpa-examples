...
@Service
@Transactional
public class Chapter6_0Service2 {
    ...
    public void initDeparnment() {
        ...
        System.out.println("6.02 contains TRUE=" + em.contains(dept));
    }

    public void setNameDep(String newName) {
        System.out.println("6.02 contains TRUE=" + em.contains(dept));
        System.out.println("6.02 JOINED FALSE=" + em.isJoinedToTransaction());
        em.joinTransaction();
        dept.setName(newName);
    }

    public void print() {
        System.out.println("6.02 result=" +
